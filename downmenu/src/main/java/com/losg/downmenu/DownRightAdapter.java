...
public class DownRightAdapter extends RecyclerView.Adapter<DownRightAdapter.ViewHolder> {
    ...
    @Override
    public DownRightAdapter.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
    ...
    @Override
    public void onBindViewHolder(DownRightAdapter.ViewHolder holder, int position) {
